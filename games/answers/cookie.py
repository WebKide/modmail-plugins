fortune_cookies = [
    ...
    "You’ll finally understand that weird advice I gave you some time ago.",
    ...
    "You’ll win an argument by quoting chatGPT.\nHere’s a summary of your question.",
    ...
    "Your future includes an awkward high-five Vs fist-bump.",
    ...
    "You are a wrong choice away from finding true love.",
